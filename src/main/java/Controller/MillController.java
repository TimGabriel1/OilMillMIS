...
//        millingExpense.setFruitPurchase(Double.valueOf(fruitPurchase));
        ...
        if (millId.isEmpty()) {
            ...
            if (millDAO.saveMill(mill)) {
                ...
                if (millingExpenseDAO.saveMillingExpense(millingExpense) && millingProductDAO.update(millingProduct)) {
            ...
            if (millDAO.updateMill(mill) && millingExpenseDAO.updateMillingExpense(millingExpense) && millingProductDAO.update(millingProduct)) {
